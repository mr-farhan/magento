...
class Interceptor extends \Magento\CustomerGraphQl\Model\Resolver\ChangePassword implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\CustomerGraphQl\Model\Customer\GetCustomer $getCustomer, \Magento\CustomerGraphQl\Model\Customer\CheckCustomerPassword $checkCustomerPassword, \Magento\Customer\Api\AccountManagementInterface $accountManagement, \Magento\CustomerGraphQl\Model\Customer\ExtractCustomerData $extractCustomerData, ?\Magento\Customer\Model\EmailNotificationInterface $emailNotification = null)
    {
        $this->___init();
        parent::__construct($getCustomer, $checkCustomerPassword, $accountManagement, $extractCustomerData, $emailNotification);
    }
