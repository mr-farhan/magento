...
class Interceptor extends \Magento\CatalogGraphQl\Model\Resolver\Aggregations implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\CatalogGraphQl\DataProvider\Product\LayeredNavigation\LayerBuilder $layerBuilder, ?\Magento\Directory\Model\PriceCurrency $priceCurrency = null, ?\Magento\CatalogGraphQl\DataProvider\Product\LayeredNavigation\Builder\Aggregations\Category\IncludeDirectChildrenOnly $includeDirectChildrenOnly = null)
    {
        $this->___init();
        parent::__construct($layerBuilder, $priceCurrency, $includeDirectChildrenOnly);
    }
