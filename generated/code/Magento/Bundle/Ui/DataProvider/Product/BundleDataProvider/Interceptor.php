...
class Interceptor extends \Magento\Bundle\Ui\DataProvider\Product\BundleDataProvider implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct($name, $primaryFieldName, $requestFieldName, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $collectionFactory, \Magento\Bundle\Helper\Data $dataHelper, array $meta = [], array $data = [], array $addFieldStrategies = [], array $addFilterStrategies = [], ?\Magento\Ui\DataProvider\Modifier\PoolInterface $modifiersPool = null)
    {
        $this->___init();
        parent::__construct($name, $primaryFieldName, $requestFieldName, $collectionFactory, $dataHelper, $meta, $data, $addFieldStrategies, $addFilterStrategies, $modifiersPool);
    }
