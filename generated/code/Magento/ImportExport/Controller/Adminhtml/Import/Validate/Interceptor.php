...
class Interceptor extends \Magento\ImportExport\Controller\Adminhtml\Import\Validate implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\ImportExport\Model\Report\ReportProcessorInterface $reportProcessor, \Magento\ImportExport\Model\History $historyModel, \Magento\ImportExport\Helper\Report $reportHelper, ?\Magento\Framework\Escaper $escaper = null, ?\Magento\ImportExport\Model\Import\RenderErrorMessages $renderErrorMessages = null)
    {
        $this->___init();
        parent::__construct($context, $reportProcessor, $historyModel, $reportHelper, $escaper, $renderErrorMessages);
    }
