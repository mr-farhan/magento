...
/**
 * Plugin creating nonce from Magento Vault Braintree Google Pay public hash
 */
class SetGooglePayVaultPaymentNonce
{
    /**
    ...
    public function beforeExecute(
        ...
        try {
            ...
            if ($nonceResult === null) {
                $this->logger->critical('Failed to get Braintree Google Pay Vault nonce');
