...
/**
 * Resolver for mutation validateSandboxKeys
 */
class ValidateSandboxKeys implements ResolverInterface
{
    /**
    ...
    {
        return ['message' => $this->connectionValidator->validate('sandbox')];
    }
}
